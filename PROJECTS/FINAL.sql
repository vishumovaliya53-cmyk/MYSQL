...
SELECT STUDENTID FROM ENROLLMENTS WHERE COURSEID = (SELECT COURSEID FROM COURSES WHERE COURSENAME = 'Introduction to SQL')
AND STUDENTID IN (SELECT STUDENTID FROM ENROLLMENTS WHERE COURSEID = (SELECT COURSEID FROM COURSES WHERE COURSENAME = 'Data Structures'));

-- 6. Students enrolled in EITHER 'Introduction to SQL' OR 'Data Structures':
SELECT DISTINCT STUDENTID FROM ENROLLMENTS 
WHERE COURSEID IN (SELECT COURSEID FROM COURSES WHERE COURSENAME IN ('Introduction to SQL', 'Data Structures'));
